"""E2E — bugfix.yaml v1 must pass the lint cleanly (ADR 0003 P1 validation #4)."""
...
WORKFLOW_PATH = (
    Path(__file__).resolve().parent.parent.parent / "workflows" / "v1" / "bugfix.yaml"
)


def test_bugfix_v1_lints_cleanly() -> None:
